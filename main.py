...
# Making Icon For Frame
icon = tk.PhotoImage(file="images\\battleship.png")
game_frame.iconphoto(False,icon)


# Providing User with Option to simmulate a randomly generated board
...
# Providing User with Option to simmulate a board generated by them
